...
let carouselItems = [[main1, "반려동물의 다양한 정보", " 반려인이 쉽고 편리하게 정보를 얻고 소통할 수 있는 공간"], [main2, "반려동물과 함께 할 수 있는 장소", "반려인과 반려동물이 즐거운 경험과 추억을 만들 수 있도록"], [main3, "반려동물에게 좋은 것만", "반려인과 반려동물의 행복한 삶을 위해 가장 좋은 상품 제공"]]
